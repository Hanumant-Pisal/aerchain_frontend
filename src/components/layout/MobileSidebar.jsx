...
export default function MobileSidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-72 bg-gradient-to-br from-purple-600 via-purple-500 to-pink-500 transform transition-transform duration-300 ease-in-out md:hidden ${
